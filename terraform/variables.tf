variable "deployment_redis" {
  ...
  default  = {
    ...
    name            = "redis"
    replica_number  = 1
    container_image = "ghcr.io/stanisz1/redis:0.24.0"
...
variable "deployment_backend" {
  ...
  default  = {
    ...
    name            = "backend"
    replica_number  = 1
    container_image = "ghcr.io/stanisz1/back:0.24.0"
    container_name  = "back"
  }
}
variable "deployment_frontend" {
  ...
  default  = {
    ...
    name            = "frontend"
    replica_number  = 1
    container_image = "ghcr.io/stanisz1/front:0.24.0"
    container_name  = "end"
  }
}
variable "deployment_nginx" {
  ...
  default  = {
    ...
    name            = "nginx"
    replica_number  = 1
    container_image = "ghcr.io/stanisz1/nginx:0.24.0"
